...
- **Queued:** Unit 4 (カタカナ — waiting on Alex's base64 re-send); speech grading (Brief C, design doc ready); capture agent voice settings → tune lesson clips; mastery-feel tuning; mascot costumes; mini-games (Future).
